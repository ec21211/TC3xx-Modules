...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
/* Configure 4 LED's on the Triboard */
#define LED1         &MODULE_P20,11                                           /* LED: Port, Pin definition            */
#define LED2         &MODULE_P20,12                                           /* LED: Port, Pin definition            */
#define LED3         &MODULE_P20,13                                           /* LED: Port, Pin definition            */
#define LED4         &MODULE_P20,14                                           /* LED: Port, Pin definition            */
...
{
    IfxPort_togglePin(LED3);                                                     /* Toggle the state of the LED      */
}
void toggleLED4(void)
{
    IfxPort_togglePin(LED4);                                                     /* Toggle the state of the LED      */
}
