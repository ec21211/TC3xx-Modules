...
//            .baseAddress                    = (uint32)&MODULE_CAN0,
            .baseAddress                    = (uint32)(can->can),  // bug fix. This used to be (uint32)&MODULE_CAN0,
...
//AP Added:
//    defaultConfig.messageRAM.baseAddress = (uint32)can;
//    defaultConfig.messageRAM.baseAddress = *can->can;
    /* Default Configuration */
    *config = defaultConfig;
