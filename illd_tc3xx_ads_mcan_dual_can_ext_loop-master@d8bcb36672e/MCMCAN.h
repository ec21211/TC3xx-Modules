...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define CAN0_MESSAGE_ID              (uint32)0x777          /* Message ID that will be used in arbitration phase    */
#define CAN1_MESSAGE_ID              (uint32)0x444          /* Message ID that will be used in arbitration phase    */
...
#define ISR_PRIORITY_CAN0_TX         2                      /* Define the CAN TX interrupt priority                 */
...
#define ISR_PRIORITY_CAN1_RX         3                      /* Define the CAN RX interrupt priority                 */
#define TX_DATA_LOW_WORD            (uint32)0x01234567      /* Define CAN data lower word to be transmitted         */
#define TX_DATA_HIGH_WORD           (uint32)0x89ABCDEF      /* Define CAN data higher word to be transmitted        */
